function stdV_mc = UAcode(Vindex,Sbrindex,time)
...
%             V.mag.meas.index = [1:1:node.num]';               % indication of the nodes where voltage magnitude meas are placed.
            ...
            S.br1.meas.index = Sbrindex';%[1:1:branch.num]';               % indication of the branches where active and reactive power meas are placed (measurement on the starting side of the branch).
...
%             V.mag.meas.unc = [1;50;50;50;50;50;1;50;50;1];          % uncertainty (in percent) of voltage magnitude measurements
            ...
            S.br1.meas.unc = 2;%[500;500;500;500;500;500;500;500;500];           % uncertainty (in percent) of active and reactive branch power measurements
